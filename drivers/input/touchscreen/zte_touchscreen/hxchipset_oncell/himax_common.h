...
#endif
#define HIMAX_DRIVER_VER "0.2.17.0_ABCD1234_01"
...
/* #define HX_PROTOCOL_A */   /* for MTK.If turning on,it will report to system by using specific format.*/
...
struct himax_ts_data {
	...
	struct notifier_block adf_fb_notif;
...
#ifdef HX_TP_PROC_2T2R
extern void freeMutualBuffer_2(void);
#endif
#endif
