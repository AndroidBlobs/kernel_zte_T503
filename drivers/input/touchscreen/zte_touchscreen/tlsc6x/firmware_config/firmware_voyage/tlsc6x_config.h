...
#define OPTIMIZE_VID_PID /* use optimize vid pid */
/*
 * FW.h file for auto upgrade, you must replace it with your own
 * define your own fw_file, the sample one to be replaced is invalid
 */

#define TLSC_UPGRADE_FW_FILE                      "tls_tp_LCE_CTC.h"

#define TLSC_UPGRADE_FW1_FILE                     "tls_tp_LCE_HS.h"

#define TLSC_UPGRADE_FW2_FILE                     "tls_tp_YKL_YUYE.h"

#define TLSC_UPGRADE_FW3_FILE                     "tls_tp_YKL_SAIHUA.h"
/*********************************************************/
